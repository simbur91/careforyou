...
use CF\CarBundle\Entity\Driver;
use CF\CarBundle\Form\DriverType;
...
class DriverController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $drivers = $em->getRepository('CFCarBundle:Driver')->findAll();
    ...
    {
        $driver = new Driver();
        $form = $this->createForm('CF\CarBundle\Form\DriverType', $driver);
    ...
    {
        $deleteForm = $this->createDeleteForm($driver);
        $editForm = $this->createForm('CF\CarBundle\Form\DriverType', $driver);
