...
use CF\CarBundle\Entity\Message;
use CF\CarBundle\Form\MessageType;
...
class MessageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $messages = $em->getRepository('CFCarBundle:Message')->findAll();
    ...
    {
        $message = new Message();
        $form = $this->createForm('CF\CarBundle\Form\MessageType', $message);
    ...
    {
        $deleteForm = $this->createDeleteForm($message);
        $editForm = $this->createForm('CF\CarBundle\Form\MessageType', $message);
