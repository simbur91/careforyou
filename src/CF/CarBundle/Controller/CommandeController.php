...
use CF\CarBundle\Entity\Commande;
use CF\CarBundle\Form\CommandeType;
...
class CommandeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $commandes = $em->getRepository('CFCarBundle:Commande')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('CF\CarBundle\Form\CommandeType', $commande);
    ...
    {
        $deleteForm = $this->createDeleteForm($commande);
        $editForm = $this->createForm('CF\CarBundle\Form\CommandeType', $commande);
