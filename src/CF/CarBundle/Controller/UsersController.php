...
use CF\CarBundle\Form\UsersType;
...
class UsersController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $users = $em->getRepository('CFCarBundle:Users')->findAll();
    ...
    {
        $user = new Users();
        $form = $this->createForm('CF\CarBundle\Form\UsersType', $user);
    ...
    {
        $deleteForm = $this->createDeleteForm($user);
        $editForm = $this->createForm('CF\CarBundle\Form\UsersType', $user);
